...
<title>Halaman Layanan Publik-Desa Sumberejo</title>
    <!-- Title -->
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url();?>/C_Layanan/ShowLayanan">Layanan Publik</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                  <div class="post-details-content bg-white mb-30 " style="margin-top: -20px;"> 
                    <?php 
                    $no=1;
                    if (is_array($layanan2) || is_object($layanan2)){
                    foreach ($layanan2 as $l){ ?>
                          <div class="section-home">
                            <h4 class="post-title" style="text-align: center;"><?php echo $l->judul_layanan?></h4>
                         </div>  
                         ...
                         <div class="post-meta">
                            ...
                            <img src="<?php echo base_url();?>Assets/foto/<?php echo $l->foto_layanan?>" alt="">
                        </div>
                        <!-- Single Catagory Post -->

                    <div class="blog-content">
                           
                            <p><?php echo $l->isi_layanan?></p> 
                        </div>
                <?php } } ?>
                </div>
                </div>

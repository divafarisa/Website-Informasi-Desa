            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                    ...
                    <div class="blog-thumb mb-30">
                            <img src="<?php echo base_url();?>Assets/foto/<?php echo $u->foto_umkm?>" alt="">
                        </div>
                        <!-- Single Catagory Post -->
                    
                    <div class="blog-content">
                            
                            <h4 class="post-title"><?php echo $u->nama_umkm?></h4>
                            <p style="text-align: justify;"><?php echo $u->deskripsi_umkm?></p>

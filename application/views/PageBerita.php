        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                    <h2 style="color: black;">Daftar Berita</h2> 
                      <br>
                    ...
                    foreach ($berita as $b){ ?>
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="background-image: url(Assets/foto/<?php echo $b->foto_berita?>);">
                                <img src="<?php echo base_url();?>Assets/foto/<?php echo $b->foto_berita?>" width="300" height="300">
                            ...
                            <div class="post-content">
                                ...
                                <a href="<?php echo base_url();?>C_Berita/showSingleBerita?id_berita=<?php echo $b->id_berita?>" class="post-title"><?php echo $b->judul_berita ?></a>
                                <!-- Post Meta -->

      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <h4><center>Tambah Artikel</center></h4>
          </li>
          
        </ol>
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>C_Apbd/tambah">
          <p>Tahun : </p>
          <div class="form-group">
            <input class="form-control" name="tahun_apbd" id="tahun_apbd" type="text"  required="required" >
            <p class="help-block text-danger"></p>
          </div>
          <p>Foto APBD : </p>
          <div class="form-group">
            <input type="file" id="foto_apbd" name="foto_apbd" required="required">
            <p class="help-block text-danger"></p>
          </div>

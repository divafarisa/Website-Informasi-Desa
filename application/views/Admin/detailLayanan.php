            ...
            <div class="row justify-content-center">
                ...
                <div class="post-details-content bg-white mb-30 p-30 box-shadow">
                    ...
                    <div class="blog-thumb mb-30">
                            <img src="<?php echo base_url();?>Assets/foto/<?php echo $l->foto_layanan?>" width  = "700" height = "400" alt="">
                        </div>
                    ...
                    <div class="blog-content">
                            <div class="post-meta">
                                ...
                                <h4 class="post-title"><?php echo $l->judul_layanan?></h4>
                            </div>
                            <br>
                            <a ><?php echo $l->tanggal_layanan?></a>
                            <br><br> 
                            <p style="text-align: justify;"><?php echo $l->isi_layanan?></p>
                               
                        </div>

                    <a href="<?php echo base_url();?>C_Layanan/showHalamanEditLayanan?id_layanan=<?php echo $l->id_layanan?>" class="btn btn-primary btn-md">Edit Layanan</a>

  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <a href="<?php echo base_url();?>C_Apbd/ShowHalamanTambahApbd" class="btn btn-primary btn-md">Tambah APBD</a>
        <br>
        <br>
        <table class="table">
            <thead>
                <tr>
                <th scope="col">Id APBD</th>
                <th scope="col">Tahun APBD</th>
          ...
          if (is_array($apbd) || is_object($apbd)){
              foreach ($apbd as $a){ ?>
              <tbody>
              <td><?php echo $a->id_apbd ?></td>
              <td><?php echo $a->tahun_apbd ?></a></td>
              <td><img src="<?php echo base_url();?>Assets/foto/<?php echo $a->foto_apbd?>" width="100" height="100"></td>
              <td>
              <a href="<?php echo base_url();?>C_Apbd/hapusApbd?id_apbd=<?php echo $a->id_apbd?>">Delete</a>
              </td>
              </tbody>
          <?php } } ?>
      </table>    

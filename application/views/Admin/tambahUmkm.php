      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a ><center>Tambah UMKM</center></a>
          </li>
          
        </ol>
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>C_Umkm/tambah">
          <p>Nama UMKM : </p>
          <div class="form-group">
            <input class="form-control" name="nama_umkm" id="nama_umkm" type="text"  required="required" >
            <p class="help-block text-danger"></p>
          </div>
          <p>Deskripsi UMKM : </p>
          <div class="form-group">
            <textarea class="form-control" name="deskripsi_umkm" id="deskripsi_umkm" type="text"  required="required" ></textarea>
            <p class="help-block text-danger"></p>
          </div>
          <p>Foto UMKM : </p>
          <div class="form-group">
            <input type="file" id="foto_umkm" name="foto_umkm" required="required">
            <p class="help-block text-danger"></p>
          </div>

      ...
      <div class="container-fluid">
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>C_Artikel/tambah">
          ...
          <div class="form-group">
            <input class="form-control" name="judul_artikel" id="judul_artikel" type="text"  required="required" >
            <p class="help-block text-danger"></p>
          </div>
          <p>Isi Artikel : </p>
          <div class="form-group">
            <textarea class="form-control" name="isi_artikel" id="isi_artikel" required="required" ></textarea>
            <p class="help-block text-danger"></p>
            </div>
          <p>Foto Artikel : </p>
          <div class="form-group">
            <input type="file" id="foto_artikel" name="foto_artikel" required="required">
            <p class="help-block text-danger"></p>
          </div>
